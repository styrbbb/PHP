...
<html lang="et">
    ...
    <body>
        ...
        /*  Harjutus 05
            ...
            07.02.2024
        */
            $nimed = array('mari', 'kati', 'juhan', 'miku', 'kat', 'maria', 'suzuki', 'helis');
            //sorteerimine
            ksort($nimed);
            //Väljastab nimed massivist
            ...
            //Väljastab esimesed kolm nime
            echo "<b>Esimesed 3 nime</b><br>"; 
            for ($i = 0; $i < 3; $i++) {
                echo "$nimed[$i]<br>";
            }
            echo "<br>";
            //Väljastab viimase nime 
            echo "<b>Viimane nimi</b><br>";
            echo $nimed[7];
            
            echo "<br>";
            echo "<br>";
            //Väljastab suvalise nime
            echo "<b>Suvaline nimi</b><br>";
