        ...
        <header class="bg-dark py-5">
            <div class="container px-4 px-lg-5 my-5">
                <div class="text-center text-white">
                    <h1 class="display-3">Teenused</h1>
                ...
                <div class="row gx-4 gx-lg-5 row-cols-2 row-cols-md-3 row-cols-xl-4 justify-content-center">
                        ...
                        <div class="card h-100">
                            ...
                            <div class="card-body p-4">
                                <div class="text-center">
                                    <h5 class="fw-bolder">Arvuti diagnostika</h5>
                                    <p class="">Lorem ipsum dolor sit amet consectetur adipisicing elit. Assumenda, nisi eligendi!</p>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="col mb-5">
                        <div class="card h-100">
                            ...
                            <div class="card-body p-4">
                                <div class="text-center">
                                    <h5 class="fw-bolder">Arvutite remont</h5>
                                    <p class="">Lorem ipsum dolor sit amet consectetur adipisicing elit. Assumenda, nisi eligendi!</p>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="col mb-5">
                        <div class="card h-100">
                            <img class="card-img-top" src="https://picsum.photos/id/7/600/400" alt="..." />
                            <div class="card-body p-4">
                                <div class="text-center">
                                    <h5 class="fw-bolder">Tarkvara paigaldus</h5>
                                    <p class="">Lorem ipsum dolor sit amet consectetur adipisicing elit. Assumenda, nisi eligendi!</p>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="col mb-5">
                        <div class="card h-100">
                            <img class="card-img-top" src="https://picsum.photos/id/3/600/400" alt="..." />
                            <div class="card-body p-4">
                                <div class="text-center">
                                    <h5 class="fw-bolder">Andmete taastamine</h5>
                                    <p class="">Lorem ipsum dolor sit amet consectetur adipisicing elit. Assumenda, nisi eligendi!</p>
                                </div>
                            </div>
                        </div>
